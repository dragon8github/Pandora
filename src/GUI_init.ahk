...
; 数据源
myPath := { "home": "/home/dc-user/", "nginx安装目录": "/usr/local/nginx", "nginx.conf": "/usr/local/nginx/conf/nginx.conf", "php-fpm": "/usr/local/bin/php-fpm", "Nginx": "/usr/local/nginx/sbin/nginx", "nginx html": "/usr/local/nginx/html/", "php.ini": "/usr/local/php/php.ini" }

; 创建含名称和大小两列的 ListView:
Gui, ISearch:Add, ListView, r7 w800 h500 gMyListView xs, Name|Path

For key, value in myPath
	LV_Add("", key, value)
